      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((product) => (
            <div key={product.id} className="bg-white rounded-2xl shadow-sm hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 group">
              ...
              <div className="p-6">
                ...
                <button className="w-full py-2.5 bg-gray-900 hover:bg-[#6B3FA0] text-white font-semibold rounded-xl transition-colors">
                  Add to Cart
                </button>
              </div>
            </div>
